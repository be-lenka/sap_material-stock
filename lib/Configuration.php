...
namespace BeLenka\SAP\MaterialStock;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://:/sap/opu/odata/sap/API_MATERIAL_STOCK_SRV';
    ...
    {
        $report  = 'PHP SDK (BeLenka\SAP\MaterialStock) Debug Report:' . PHP_EOL;
