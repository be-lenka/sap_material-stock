<?php
/**
 * APIMATERIALSTOCKSRVAMaterialSerialNumberTypeUpdate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APIMATERIALSTOCKSRVAMaterialSerialNumberTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\MaterialStock
 * @author   OpenAPI Generator team
 ...
 */
class APIMATERIALSTOCKSRVAMaterialSerialNumberTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_MATERIAL_STOCK_SRV.A_MaterialSerialNumberType-update';
    ...
    */
    ...
    public function setPlant($plant)
    {
        ...
        if (!is_null($plant) && (mb_strlen($plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $plant when calling APIMATERIALSTOCKSRVAMaterialSerialNumberTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setStorageLocation($storage_location)
    {
        ...
        if (!is_null($storage_location) && (mb_strlen($storage_location) > 4)) {
            throw new \InvalidArgumentException('invalid length for $storage_location when calling APIMATERIALSTOCKSRVAMaterialSerialNumberTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setInventorySpecialStockType($inventory_special_stock_type)
    {
        ...
        if (!is_null($inventory_special_stock_type) && (mb_strlen($inventory_special_stock_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $inventory_special_stock_type when calling APIMATERIALSTOCKSRVAMaterialSerialNumberTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setBatch($batch)
    {
        ...
        if (!is_null($batch) && (mb_strlen($batch) > 10)) {
            throw new \InvalidArgumentException('invalid length for $batch when calling APIMATERIALSTOCKSRVAMaterialSerialNumberTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setInventoryStockType($inventory_stock_type)
    {
        ...
        if (!is_null($inventory_stock_type) && (mb_strlen($inventory_stock_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $inventory_stock_type when calling APIMATERIALSTOCKSRVAMaterialSerialNumberTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setEquipment($equipment)
    {
        ...
        if (!is_null($equipment) && (mb_strlen($equipment) > 18)) {
            throw new \InvalidArgumentException('invalid length for $equipment when calling APIMATERIALSTOCKSRVAMaterialSerialNumberTypeUpdate., must be smaller than or equal to 18.');
        }
    ...
    public function setCustomer($customer)
    {
        ...
        if (!is_null($customer) && (mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APIMATERIALSTOCKSRVAMaterialSerialNumberTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setSupplier($supplier)
    {
        ...
        if (!is_null($supplier) && (mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APIMATERIALSTOCKSRVAMaterialSerialNumberTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setSdDocument($sd_document)
    {
        ...
        if (!is_null($sd_document) && (mb_strlen($sd_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sd_document when calling APIMATERIALSTOCKSRVAMaterialSerialNumberTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setSdDocumentItem($sd_document_item)
    {
        ...
        if (!is_null($sd_document_item) && (mb_strlen($sd_document_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sd_document_item when calling APIMATERIALSTOCKSRVAMaterialSerialNumberTypeUpdate., must be smaller than or equal to 6.');
        }
    ...
    public function setWbsElementInternalId($wbs_element_internal_id)
    {
        ...
        if (!is_null($wbs_element_internal_id) && (mb_strlen($wbs_element_internal_id) > 8)) {
            throw new \InvalidArgumentException('invalid length for $wbs_element_internal_id when calling APIMATERIALSTOCKSRVAMaterialSerialNumberTypeUpdate., must be smaller than or equal to 8.');
        }
    ...
    public function setWbsElementExternalId($wbs_element_external_id)
    {
        ...
        if (!is_null($wbs_element_external_id) && (mb_strlen($wbs_element_external_id) > 24)) {
            throw new \InvalidArgumentException('invalid length for $wbs_element_external_id when calling APIMATERIALSTOCKSRVAMaterialSerialNumberTypeUpdate., must be smaller than or equal to 24.');
        }
