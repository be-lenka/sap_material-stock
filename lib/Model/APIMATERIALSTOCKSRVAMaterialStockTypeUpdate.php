...
/**
 * APIMATERIALSTOCKSRVAMaterialStockTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\MaterialStock
 * @author   OpenAPI Generator team
 ...
 */
class APIMATERIALSTOCKSRVAMaterialStockTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_MATERIAL_STOCK_SRV.A_MaterialStockType-update';
    ...
    */
    ...
    public function setMaterialBaseUnit($material_base_unit)
    {
        ...
        if (!is_null($material_base_unit) && (mb_strlen($material_base_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $material_base_unit when calling APIMATERIALSTOCKSRVAMaterialStockTypeUpdate., must be smaller than or equal to 3.');
        }
