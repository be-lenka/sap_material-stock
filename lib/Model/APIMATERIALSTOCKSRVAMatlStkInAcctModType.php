<?php
/**
 * APIMATERIALSTOCKSRVAMatlStkInAcctModType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APIMATERIALSTOCKSRVAMatlStkInAcctModType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\MaterialStock
 * @author   OpenAPI Generator team
 ...
 */
class APIMATERIALSTOCKSRVAMatlStkInAcctModType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_MATERIAL_STOCK_SRV.A_MatlStkInAcctModType';
    ...
    protected static $openAPITypes = [
        ...
        'to_material_serial_number' => '\BeLenka\SAP\MaterialStock\Model\APIMATERIALSTOCKSRVAMatlStkInAcctModTypeToMaterialSerialNumber',
        'to_material_stock' => '\BeLenka\SAP\MaterialStock\Model\APIMATERIALSTOCKSRVAMaterialStockType'
    ];
    ...
    */
     ...
     * Sets material
     *
     * @param string|null $material Material in Respect of Which Stock is Managed
     *
     * @return self
     */
    public function setMaterial($material)
    {
        ...
        if ((mb_strlen($material) > 40)) {
            throw new \InvalidArgumentException('invalid length for $material when calling APIMATERIALSTOCKSRVAMatlStkInAcctModType., must be smaller than or equal to 40.');
        }
    ...
    public function setPlant($plant)
    {
        ...
        if ((mb_strlen($plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $plant when calling APIMATERIALSTOCKSRVAMatlStkInAcctModType., must be smaller than or equal to 4.');
        }
    ...
    public function setStorageLocation($storage_location)
    {
        ...
        if ((mb_strlen($storage_location) > 4)) {
            throw new \InvalidArgumentException('invalid length for $storage_location when calling APIMATERIALSTOCKSRVAMatlStkInAcctModType., must be smaller than or equal to 4.');
        }
     ...
     * Sets batch
     *
     * @param string|null $batch Batch Number (Stock Identifier)
     *
     * @return self
     */
    public function setBatch($batch)
    {
        ...
        if ((mb_strlen($batch) > 10)) {
            throw new \InvalidArgumentException('invalid length for $batch when calling APIMATERIALSTOCKSRVAMatlStkInAcctModType., must be smaller than or equal to 10.');
        }
     ...
     * Sets supplier
     *
     * @param string|null $supplier Supplier for Special Stock
     *
     * @return self
     */
    public function setSupplier($supplier)
    {
        ...
        if ((mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APIMATERIALSTOCKSRVAMatlStkInAcctModType., must be smaller than or equal to 10.');
        }
     ...
     * Sets customer
     *
     * @param string|null $customer Customer for Special Stock
     *
     * @return self
     */
    public function setCustomer($customer)
    {
        ...
        if ((mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APIMATERIALSTOCKSRVAMatlStkInAcctModType., must be smaller than or equal to 10.');
        }
    ...
    public function setWbsElementInternalId($wbs_element_internal_id)
    {
        ...
        if ((mb_strlen($wbs_element_internal_id) > 8)) {
            throw new \InvalidArgumentException('invalid length for $wbs_element_internal_id when calling APIMATERIALSTOCKSRVAMatlStkInAcctModType., must be smaller than or equal to 8.');
        }
     ...
     * Sets sd_document
     *
     * @param string|null $sd_document Sales order number of valuated sales order stock
     *
     * @return self
     */
    public function setSdDocument($sd_document)
    {
        ...
        if ((mb_strlen($sd_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sd_document when calling APIMATERIALSTOCKSRVAMatlStkInAcctModType., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string|null $sd_document_item Sales Order Item of Valuated Sales Order Stock
     *
     * @return self
     */
    public function setSdDocumentItem($sd_document_item)
    {
        ...
        if ((mb_strlen($sd_document_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sd_document_item when calling APIMATERIALSTOCKSRVAMatlStkInAcctModType., must be smaller than or equal to 6.');
        }
    ...
    public function setInventorySpecialStockType($inventory_special_stock_type)
    {
        ...
        if ((mb_strlen($inventory_special_stock_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $inventory_special_stock_type when calling APIMATERIALSTOCKSRVAMatlStkInAcctModType., must be smaller than or equal to 1.');
        }
    ...
    public function setInventoryStockType($inventory_stock_type)
    {
        ...
        if ((mb_strlen($inventory_stock_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $inventory_stock_type when calling APIMATERIALSTOCKSRVAMatlStkInAcctModType., must be smaller than or equal to 2.');
        }
    ...
    public function setWbsElementExternalId($wbs_element_external_id)
    {
        ...
        if (!is_null($wbs_element_external_id) && (mb_strlen($wbs_element_external_id) > 24)) {
            throw new \InvalidArgumentException('invalid length for $wbs_element_external_id when calling APIMATERIALSTOCKSRVAMatlStkInAcctModType., must be smaller than or equal to 24.');
        }
    ...
    public function setMaterialBaseUnit($material_base_unit)
    {
        ...
        if (!is_null($material_base_unit) && (mb_strlen($material_base_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $material_base_unit when calling APIMATERIALSTOCKSRVAMatlStkInAcctModType., must be smaller than or equal to 3.');
        }
     ...
     *
     * @return \BeLenka\SAP\MaterialStock\Model\APIMATERIALSTOCKSRVAMatlStkInAcctModTypeToMaterialSerialNumber|null
     */
     ...
     *
     * @param \BeLenka\SAP\MaterialStock\Model\APIMATERIALSTOCKSRVAMatlStkInAcctModTypeToMaterialSerialNumber|null $to_material_serial_number to_material_serial_number
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\MaterialStock\Model\APIMATERIALSTOCKSRVAMaterialStockType|null
     */
     ...
     *
     * @param \BeLenka\SAP\MaterialStock\Model\APIMATERIALSTOCKSRVAMaterialStockType|null $to_material_stock to_material_stock
     *
     * @return self
     */
